...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-ink flex items-center justify-center px-6 pt-24 pb-16 relative overflow-hidden">
      <motion.div
        aria-hidden
        className="absolute -top-24 -right-16 w-[420px] h-[420px] rounded-[45%_55%_65%_35%/40%_45%_55%_60%] bg-brand-red/10 blur-3xl"
      ...
      >
        <div className="mb-7">
          ...
          <h1 className="font-sans font-extrabold text-2xl text-ink mt-2">Content de vous revoir</h1>
        </div>
        ...
        <p className="text-center text-sm text-ink/50 font-light mt-6">
          ...
          <Link to="/inscription" className="text-brand-red font-semibold hover:underline">
            S'inscrire
          </Link>
        </p>
      </motion.div>
